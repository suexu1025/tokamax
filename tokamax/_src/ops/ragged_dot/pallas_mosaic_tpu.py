...
GMM_TILING_TUNED_LUT: dict[LUTKey, LUTValue] = {
    ...
    (131072, 7168, 1024, 256, False): ((512, 1792, 256), 2),
    (131072, 1024, 7168, 256, False): ((256, 2048, 2048), 4),
    ...
    (65536, 2048, 7168, 256, False): ((128, 2048, 1792), 3),
    (32768, 7168, 1024, 256, False): ((512, 7168, 512), 2),
    (32768, 1024, 7168, 256, False): ((128, 512, 2048), 3),
...
GMM_RHS_TRANSPOSE_TILING_TUNED_LUT: dict[LUTKey, LUTValue] = {
    ...
    (131072, 7168, 1024, 256, False): ((1024, 1024, 512), 2),
    (131072, 1024, 7168, 256, False): ((512, 3584, 512), 2),
    ...
    (65536, 2048, 7168, 256, False): ((256, 3584, 512), 2),
    (32768, 7168, 1024, 256, False): ((512, 256, 3584), 3),
    (32768, 1024, 7168, 256, False): ((256, 2048, 1792), 3),
...
TGMM_TILING_TUNED_LUT: dict[LUTKey, LUTValue] = {
    ...
    (131072, 7168, 1024, 256, False): ((256, 3584, 512), 3),
    (131072, 1024, 7168, 256, False): ((128, 1024, 2048), 2),
    ...
    (65536, 2048, 7168, 256, False): ((128, 3584, 256), 2),
    (32768, 7168, 1024, 256, False): ((128, 1792, 1024), 2),
    (32768, 1024, 7168, 256, False): ((512, 256, 2048), 3),
